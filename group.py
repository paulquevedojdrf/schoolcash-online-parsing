...
def main(args):
    ...
    data = sorted(
        data, key=lambda x: (teacher_order_map.get(x["Teacher"], len(teacher_order)), x["First Name"], x["Last Name"])
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--src", help="Source .csv file to parse")
    parser.add_argument("-o", "--out", help="Name of output .csv file to generate")
